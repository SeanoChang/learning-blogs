...
export function SparkleCursor() {
  ...
  useEffect(() => {
    ...
    const createSparkle = (x: number, y: number, isBurst = false) => {
      const sparkle = document.createElement("div");
      sparkle.className = isBurst ? "sparkle sparkle-burst" : "sparkle";
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (isInteractive) {
        ...
        const now = Date.now();
        if (now - lastSparkleTime.current > sparkleThrottle) {
